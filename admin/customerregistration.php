...
<div class="page-banner" style="background-image: url(assets/uploads/<?php echo $banner_registration; ?>);">
    <div class="inner">
        <h1 style="margin-left:20%;"><?php echo LANG_VALUE_16; ?></h1>
    </div>
</div>
                    ...
                    <form action="" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <?php
                                if($error_message != '') {
                                    echo "<div class='callout callout-danger' style='padding: 10px;background:#f1f1f1;margin-bottom:20px;'>".$error_message."</div>";
                                }
                                if($success_message != '') {
                                    echo "<div class='callout callout-success' style='padding: 10px;margin-bottom:20px;'>".$success_message."</div>";
                                }
                                ?>

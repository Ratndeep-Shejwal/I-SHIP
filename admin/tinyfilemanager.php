...
$default_timezone = 'America/Chicago'; // UTC

// Root path for file manager
// use absolute path of directory i.e: '/var/www/folder' or $_SERVER['DOCUMENT_ROOT'].'/folder'
$root_path = $_SERVER['DOCUMENT_ROOT'].'/AtoZShipping/uploads';

// Root url for links in file manager.Relative to $http_host. Variants: '', 'path/to/subfolder'
// Will not working if $root_path will be outside of server document root
$root_url = '/AtoZShipping/uploads';
...
// e.g. 'txt,html,css,js'
$allowed_file_extensions = 'png,pdf,mp4,jpg,jpeg';

// Allowed file extensions for upload files
// e.g. 'gif,png,jpg,html,txt'
$allowed_upload_extensions = 'png,pdf,mp4,jpg,jpeg';
...
$max_upload_size_bytes = 5000000; // size 5,000,000,000 bytes (~5GB)

...
<head>
	...
	<?php 
		...
		// Adding JQUery
		if($cur_page == 'product-add.php' || $cur_page == 'vehicle-edit.php' || $cur_page == 'vehicle-add.php' || $cur_page == 'vehicle.php' || $cur_page == 'tinyfilemanager.php') {
			echo '<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>';
		}

		if($cur_page == 'product-add.php' || $cur_page == 'vehicle-edit.php' || $cur_page == 'vehicle-add.php') {
			echo '<script src="js/jquery-loadvindata.js"></script>';
		}

		if($cur_page == 'vehicle.php') {
			echo '<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css">';
			echo '<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>';
			echo '<script src="js/jquery-updatestatus.js"></script>';
		}
	 ?>
	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="index.php" class="logo">
				<span class="logo-lg">AtoZ International Shipping</span>
			</a>
  		...
  		<aside class="main-sidebar">
    		<section class="sidebar">
      			...
      			<ul class="sidebar-menu">
                    ...
                    <!-- <li class="treeview <?php if( ($cur_page == 'size.php') || ($cur_page == 'size-add.php') || ($cur_page == 'size-edit.php') || ($cur_page == 'color.php') || ($cur_page == 'color-add.php') || ($cur_page == 'color-edit.php') || ($cur_page == 'country.php') || ($cur_page == 'country-add.php') || ($cur_page == 'country-edit.php') || ($cur_page == 'shipping-cost.php') || ($cur_page == 'shipping-cost-edit.php') || ($cur_page == 'top-category.php') || ($cur_page == 'top-category-add.php') || ($cur_page == 'top-category-edit.php') || ($cur_page == 'mid-category.php') || ($cur_page == 'mid-category-add.php') || ($cur_page == 'mid-category-edit.php') || ($cur_page == 'end-category.php') || ($cur_page == 'end-category-add.php') || ($cur_page == 'end-category-edit.php') ) {echo 'active';} ?>">
                     ...
                     <li class="treeview <?php if( ($cur_page == 'product.php') || ($cur_page == 'product-add.php') || ($cur_page == 'product-edit.php') ) {echo 'active';} ?>">
                        <a href="product-add.php">
                            <i class="fa fa-shopping-bag"></i> <span>Add Vehicle</span>
                        </a>
                    </li> 


                    <li class="treeview <?php if( ($cur_page == 'vehicle.php') ) {echo 'active';} ?>">
                        <a href="vehicle.php">
                            <i class="fa fa-sticky-note"></i> <span>Manage Vehicle</span>
                        </a>
                    </li>
			        ...
			        <li class="treeview <?php if( ($cur_page == 'customerregistration.php') ) {echo 'active';} ?>">
			          <a href="customerregistration.php">
			            <i class="fa fa-tasks"></i> <span>Customer Registration</span>
			          </a>
			        </li>

					<!-- <li class="treeview <?php if( ($cur_page == 'tinyfilemanager.php') ) {echo 'active';} ?>">
			          <a href="tinyfilemanager.php">
			            <i class="fa fa-tasks"></i> <span>File Browser</span>
			          </a>
			        </li> -->
